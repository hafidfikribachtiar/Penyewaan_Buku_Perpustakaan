...
//login & logout
Route::get('admin/dashboard', [App\Http\Controllers\Backend\DashboardController::class, 'getIndex']);
...
Route::get('admin/members/edit{id}', [App\Http\Controllers\MembersController::class, 'getEdit']);
Route::get('admin/members/delete/{id}', [App\Http\Controllers\MembersController::class, 'getDelete']);
...
Route::get('admin/transactions/edit{id}', [App\Http\Controllers\TransactionsController::class, 'getEdit']);
Route::get('admin/transactions/delete', [App\Http\Controllers\TransactionsController::class, 'getDelete']);
...
Route::get('admin/useradmin/edit{id}', [App\Http\Controllers\UserAdminController::class, 'getEdit']);
Route::get('admin/useradmin/delete', [App\Http\Controllers\UserAdminController::class, 'getDelete']);
...
Route::get('admin/transactiondetails/edit{id}', [App\Http\Controllers\TransactionDetailsController::class, 'getEdit']);
Route::get('admin/transactiondetails/delete', [App\Http\Controllers\TransactionDetailsController::class, 'getDelete']);
...
Route::get('admin/bookcategories', [App\Http\Controllers\BookCategoriesController::class, 'getIndex']);
Route::get('admin/bookcategories/add', [App\Http\Controllers\BookCategoriesController::class, 'getAdd']);
Route::post('admin/bookcategories/save', [App\Http\Controllers\BookCategoriesController::class, 'postSave']);
Route::get('admin/bookcategories/edit{id}', [App\Http\Controllers\BookCategoriesController::class, 'getEdit']);
Route::get('admin/bookcategories/delete', [App\Http\Controllers\BookCategoriesController::class, 'getDelete']);
Route::post('admin/bookcategories/{id}/edit', [App\Http\Controllers\BookCategoriesController::class, 'postEdit']);
Route::get('admin/bookcategories/detail/{id}', [App\Http\Controllers\BookCategoriesController::class, 'getDetail']);
